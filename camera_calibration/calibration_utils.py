...
class Calibrator:
    ...
    def online_phase(self, img):
        ...
        axis_labels = np.float32([[6+label_offset, 0, 0], [0, 6+label_offset, 0], [0, 0, -6-label_offset]]).reshape(-1, 3)
        ...
        for i, label in enumerate(labels):
            ...
            cv.putText(img, label, label_point, cv.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
